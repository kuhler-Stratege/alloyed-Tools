...
import net.modding.items.holzlackierung.Teer_armor;
...
public class Benennung_Registry extends modding {
	...
	//Item Benennungen
		...
		public static ItemHorse_cooked horse_cooked;
			...
			public static ItemBlockGold itemblockPlatinOre;
				...
				//Armor
				public static Mix_armor mix_helmet;
				public static Mix_armor mix_chestplate;
				public static Mix_armor mix_boots;
				public static Mix_armor mix_leggings;
			...
			public static BasicItemEisen ferro_dust;
				...
				//Armor
				public static Ferro_armor ferro_helmet;
				public static Ferro_armor ferro_chestplate;
				public static Ferro_armor ferro_leggings;
				public static Ferro_armor ferro_boots;
			...
			public static ItemTeer_stick teer_stick;
				...
				//Armor
				public static Teer_armor teer_helmet;
				public static Teer_armor teer_chestplate;
				public static Teer_armor teer_boots;
				public static Teer_armor teer_leggings;	
	...
	public void Benennung() {
		...
		//sonstiges
			...
			//Armor Materialien
			mix_armor_material = EnumHelper.addArmorMaterial("MIX", 16, new int[]{2, 4, 6, 2}, 16);
			mix_armor_material.customCraftingMaterial = mix_ingot;
			
			ferro_armor_material = EnumHelper.addArmorMaterial("FERRO", 25, new int[]{3, 4, 7, 3}, 5);
			ferro_armor_material.customCraftingMaterial = ferro_ingot;
			
			teer_armor_material = EnumHelper.addArmorMaterial("TEER", 8, new int[]{2, 3, 5, 2}, 2);
	...
	//Item Bennenungen 
		...
		mix_klumpen = new BasicItemGold("mix_klumpen");
			...
			//Armor
			mix_helmet = new Mix_armor(mix_armor_material, "helmet", proxy.addArmor("Mix_armor"), 0);
			mix_chestplate = new Mix_armor(mix_armor_material, "chestplate", proxy.addArmor("Mix_armor"), 1);
			mix_leggings = new Mix_armor(mix_armor_material, "leggings", proxy.addArmor("Mix_armor"), 2);
			mix_boots = new Mix_armor(mix_armor_material, "boots", proxy.addArmor("Mix_armor"), 3);
		...
		ferro_ingot = new BasicItemEisen("ferro_ingot");
			...
			//Armor
			ferro_helmet = new Ferro_armor(ferro_armor_material, "helmet", proxy.addArmor("Ferro_armor"), 0);
			ferro_chestplate = new Ferro_armor(ferro_armor_material, "chestplate", proxy.addArmor("Ferro_armor"), 1);
			ferro_leggings = new Ferro_armor(ferro_armor_material, "leggings", proxy.addArmor("Ferro_armor"), 2);
			ferro_boots = new Ferro_armor(ferro_armor_material, "boots", proxy.addArmor("Ferro_armor"), 3);
		...
		register(teer_eimer);
			...
			//Armor
			teer_helmet = new Teer_armor(teer_armor_material, "helmet", proxy.addArmor("Teer_armor"), 0);
			teer_chestplate = new Teer_armor(teer_armor_material, "chestplate", proxy.addArmor("Teer_armor"), 1);
			teer_leggings = new Teer_armor(teer_armor_material, "leggings", proxy.addArmor("Teer_armor"), 2);
			teer_boots = new Teer_armor(teer_armor_material, "boots", proxy.addArmor("Teer_armor"), 3);

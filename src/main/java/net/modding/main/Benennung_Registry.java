...
public class Benennung_Registry extends modding {
	...
	public void Benennung() {
		...
		//Item Bennenungen 
			...
			horse_cooked = new ItemHorse_cooked("horse_cooked", 5, false);
				...
				GameRegistry.registerItem(teer_eimer);
	...
	public void ClientOnly(FMLPreInitializationEvent preInit) {
		if (preInit.getSide() == Side.CLIENT) {
			...
			registerFluidBucket(FluidTeer.instance, teer_eimer);
	...
	public void Registry() {
		...
		//Block Registrierungen
			//Goldlegierung
			registerTeerBlock(platin_ore, itemblockPlatinOre.getClass());
			registerTeerBlock(platin_block, itemblockPlatinBlock.getClass());
